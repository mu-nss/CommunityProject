...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<!-- 테이블 제목 -->
			<h6 class="font-weight-bold text-default float-left" style="margin: 5px 0 0">Notice Update Page</h6>
		</div>
		...
		<div class="card-body">
				<form role="form" method="post" id="updateForm">
					...
					<div align="right">
						...
						<button data-oper="list" class="btn btn-secondary" type="button" onclick="location = 'list.do'">list</button>
					</div>
				</form>
			</div>
 		<!-- /.card-body -->
